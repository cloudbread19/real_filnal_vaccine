...
class FileStruct:
    ...
    def set_bool_modified(self, modify):
    ...
    # 주어진 정보로 파일 정보 저장
    # 입력값 : zip_engine_id - 압축 해제 가능 엔진 ID
    #          zip_file     - 압축 파일
    #          zipped_file     - 압축해제 대상 파일
    #          zip_structure_file     - 압축 파일의 내부를 표현하기 위한 파일 이름
    #          root_file     - 마스터 파일 (최상위 파일 이름)
    #          bool_modified    - 수정 여부
    #          bool_rezip   - 재압축 가능 여부
    #          level     - 압축 깊이
